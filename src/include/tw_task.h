...
typedef struct TW_task *TW_Task_handle_t;
...
extern terr_t TW_Task_free (TW_Task_handle_t htask);  // Free up a task

extern terr_t TW_Task_create_barrier (TW_Engine_handle_t heng,	// Must have option of global
									  int dep_tag,
									  int tag,
									  TW_Task_handle_t taskp);	// Create a new barrier task

// Controls
extern terr_t TW_Task_commit (TW_Task_handle_t htask,
							  TW_Engine_handle_t heng);			// Put the task into the dag
extern terr_t TW_Task_commit_barrier (TW_Task_handle_t htask);	// Put the task into the dag
extern terr_t TW_Task_retract (TW_Task_handle_t htask);			// Remove task form the dag

// Wait
extern terr_t TW_Task_wait (TW_Task_handle_t htask,
...
extern terr_t TW_Task_wait_ex (TW_Task_handle_t *htasks,
							   int num,
...
// Info
extern terr_t TW_Task_get_status (TW_Task_handle_t htask, int *statusp);
extern terr_t TW_Task_get_data (TW_Task_handle_t htask, void **datap);
extern terr_t TW_Task_get_tag (TW_Task_handle_t htask, int *tagp);
